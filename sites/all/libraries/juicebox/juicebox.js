...
(function (ao, an) {
	...
	var aj = (function () {
		...
		bN.extend({
			...
			globalEval: function (bX) {
				if (bX && bI.test(bX)) { (ao.execScript ||
					function (bY) {
						ao["eval"].call(ao, bY)
					})(bX)
				}
	...
	(function () {
		...
		if (al.querySelectorAll) { (function () {
				var bN = L,
	...
	a9 = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
	bi, aO = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]],
	bj;
	aj.fn.extend({
		show: function (w, e, B) {
			var A, z;
	...
	aj.extend({
		speed: function (w, z, y) {
			var x = w && typeof w === "object" ? aj.extend({},
			w) : {
...
if (typeof $ === "undefined") {
	...
	function l(J, O, H, K, N, D, G, C) {
		var I = J.data(m) ? !d(J.data(m)) ? J.data(m) : r.extend(true, {},
		w) : r.extend(true, {},
		w),
		F = N,
		M = r.inArray(O, s) > -1;
...
var juicebox_gallery_index_panel = function (T, g) {
	...
	var u = function () {
		...
		aG.html("<div class='jb-idx-show-area' style='overflow:hidden; width: 100%;margin:0;padding:0;position:absolute;'></div>" + aU + (aj.showpagingtext ? "<div class='jb-idx-thb-list-page-number' style='position: absolute;'></div>": "") + aT)
	};
	var aq = function () {
	...
	var aw = function (aZ, aY, aU, a5, aT) {
		...
		aY.append("<table class='jb-idx-thb-container jb-classifier-thumb-area table_page_" + aZ + " " + (aT ? aT: "") + "' style='left:" + aU + "px;" + (aX ? "height:100%;": "") + "' ><tr><td style='text-align:center !important;width:auto !important;'><div class='jb-idx-thb-list' style='text-align:center !important;width:" + a3 + "px;margin-left: auto;margin-right: auto; margin-top:0; margin-bottom:0; padding:0;' ><div class='div-thumb'></div></div></td></tr></table>");
		var aW = M(".table_page_" + aZ + (aT ? "." + aT: "") + " .div-thumb");
		var a4 = "";
...
juicebox_registered_components.printerest = function () {
	...
	var b = function () {
		var f = a.getGalleryInfo();
		window.open("https://pinterest.com/login/?next=/pin/create/bookmarklet/?media=" + f.imageUrl + "&description=" + f.shareText + "&is_video=false&url=" + f.shareUrl, "", "menubar=no,toolbar=no,resizable=yes,scrollbars=yes," + a.utils.get_popup_position_string(600, 420));
		return false
	};
	return {
		setContext: d,
